...
class Game:
    ...
    def intro_screen(self):
        ...
        play_button = Button(PLAY_BUTTON_X, PLAY_BUTTON_Y, INTRO_BUTTON_WIDTH, INTRO_BUTTON_HEIGTH, WHITE, BLACK, "JOGAR", FONT_SIZE_INTRO_SCREEN)

        exit_button = Button(EXIT_BUTTON_X, EXIT_BUTTON_Y, INTRO_BUTTON_WIDTH, INTRO_BUTTON_HEIGTH, WHITE, BLACK, "SAIR", FONT_SIZE_INTRO_SCREEN)
    ...
    def select_screen(self):
        if self.running:
            ...
            knight_button = Button(KNIGHT_BUTTON_X, KNIGHT_BUTTON_Y, SELECT_BUTTON_WIDTH, SELECT_BUTTON_HEIGTH, WHITE, BLACK, "KNIGHT", FONT_SIZE_SELECT_SCREEN)
            mage_button = Button(MAGE_BUTTON_X, MAGE_BUTTON_Y, SELECT_BUTTON_WIDTH, SELECT_BUTTON_HEIGTH, WHITE, BLACK, "MAGE", FONT_SIZE_SELECT_SCREEN)
            archer_button = Button(ARCHER_BUTTON_X, ARCHER_BUTTON_Y, SELECT_BUTTON_WIDTH, SELECT_BUTTON_HEIGTH, WHITE, BLACK, "ARCHER", FONT_SIZE_SELECT_SCREEN)
            assassin_button = Button(ASSASSIN_BUTTON_X, ASSASSIN_BUTTON_Y, SELECT_BUTTON_WIDTH, SELECT_BUTTON_HEIGTH, WHITE, BLACK, "ASSASSIN", FONT_SIZE_SELECT_SCREEN)
            back_button = Button(BACK_BUTTON_X, BACK_BUTTON_Y, SELECT_BUTTON_WIDTH, SELECT_BUTTON_HEIGTH, WHITE, BLACK, "VOLTAR", FONT_SIZE_SELECT_SCREEN)
