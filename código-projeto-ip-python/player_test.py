        ...
        if self.facing == 'DOWN':
            ...
            if self.change_y == 0:
                if self.select_character == "KNIGHT":
                    ...
                    self.image == self.game.character_U_spritesheet.get_sprite(MAGE_DOWN_ANIMATION_FRAME_1_X, MAGE_DOWN_ANIMATION_Y, MAGE_DOWN_ANIMATION_WIDTH, MAGE_DOWN_ANIMATION_HEIGHT)
                elif self.select_character == "ARCHER":
            ...
            if self.change_x == 0:
                if self.select_character == "KNIGHT":
                    ...
                    self.image == self.game.character_R_spritesheet.get_sprite(MAGE_DOWN_ANIMATION_FRAME_1_X, MAGE_DOWN_ANIMATION_Y, MAGE_DOWN_ANIMATION_WIDTH, MAGE_DOWN_ANIMATION_HEIGHT)
                elif self.select_character == "ARCHER":
            ...
            if self.change_x == 0:
                if self.select_character == "KNIGHT":
                    ...
                    self.image == self.game.character_L_spritesheet.get_sprite(MAGE_DOWN_ANIMATION_FRAME_1_X, MAGE_DOWN_ANIMATION_Y, MAGE_DOWN_ANIMATION_WIDTH, MAGE_DOWN_ANIMATION_HEIGHT)
                elif self.select_character == "ARCHER":
