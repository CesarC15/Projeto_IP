...
class Game:
    ...
    def create_maze(self):
        for i, row in enumerate(maze):
            for j, column in enumerate(row):
                ...
                if column == '1':
                    green_key = Green_key(self, j, i)
                    self.green_keys.add(green_key)
                
                if column == '2':
                    blue_key = Blue_key(self, j, i)
                    self.blue_keys.add(blue_key)

                if column == '3':
                    red_key = Red_key(self, j, i)
                    self.red_keys.add(red_key)

                if column == 'E':
                    enemies = Enemy(self, j, i)
                ...
                if column == 'P':
                    ...
                    if self.select_screen() == "ASSASSIN":
                        ...
                        player = Player(self, j, i, "ASSASSIN")
                        self.attack_spritesheet = Spritesheet('./img/knight_assassin_attack.png')
    ...
    def new(self):
        ...
        self.green_keys = pygame.sprite.Group()
        self.blue_keys = pygame.sprite.Group()
        self.red_keys = pygame.sprite.Group()
        ...
        self.all_sprites.add(self.green_keys)
        self.all_sprites.add(self.blue_keys)
        self.all_sprites.add(self.red_keys)
