...
from banco_de_dados import stats_cavaleiro, stats_arqueiro, stats_mago, stats_assassino, ataques_iniciais_cavaleiro, ataques_existentes_cavaleiro, ataques_iniciais_mago, ataques_existentes_mago, ataques_iniciais_arqueiro, ataques_existentes_arqueiro, ataques_iniciais_assassino, ataques_existentes_assassino
import random
...
if mapa == 1:
    inimigo = Inimigo(stats_inimigo, ataques_inimigo) #falta definir os stats e os ataques do inimigo
...
print(jogador.stats)
jogador.stats = combate(jogador.stats, dic_inimigo, jogador.ataques_obtidos, dic_ataques_inimigo, vez)
print(jogador.stats)