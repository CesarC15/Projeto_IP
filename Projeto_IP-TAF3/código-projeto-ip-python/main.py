...
class Game:
    ...
    def draw(self):
        ...
        collectable_green = Button(450, 435, 150, 35, WHITE, BLACK, f"CHAVE VERDE: {verde}", 12)
        self.screen.blit(collectable_green.image, collectable_green.rect)

        collectable_blue = Button(250, 435, 150, 35, WHITE, BLACK, f"CHAVE AZUL: {azul}", 12)
        self.screen.blit(collectable_blue.image, collectable_blue.rect)

        collectable_red = Button(50, 435, 150, 35, WHITE, BLACK, f"CHAVE VERMELHA: {vermelho}", 12)
