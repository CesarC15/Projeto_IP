...
class Player(pygame.sprite.Sprite):
    ...
    def animate(self):
        if self.select_character == 'KNIGHT':
            down_animations = [self.game.character_spritesheet.get_sprite(KNIGHT_DOWN_ANIMATION_FRAME_1_X, KNIGHT_DOWN_ANIMATION_Y, KNIGHT_DOWN_ANIMATION_WIDTH, KNIGHT_DOWN_ANIMATION_FRAME_1_HEIGHT),
        ...
        if self.select_character == 'MAGE':
            down_animations = [self.game.character_spritesheet.get_sprite(MAGE_DOWN_ANIMATION_FRAME_1_X, MAGE_DOWN_ANIMATION_Y, MAGE_DOWN_ANIMATION_WIDTH, MAGE_DOWN_ANIMATION_HEIGHT),
